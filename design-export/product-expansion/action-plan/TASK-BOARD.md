...
**Foundations ready to build:** `F5` (delivery) · `F7` (search) · `F8` (Aurora patterns). _(`F3` jobs/outbox + `F1` Person + `F4` documents + `F2` import all **done** — [PR #42](https://github.com/Ewosoft-Solutions/claude-trial/pull/42) merged to `main`. **WB1 (People directory)** now unblocked — needs F1 + F7 + F8.)_
