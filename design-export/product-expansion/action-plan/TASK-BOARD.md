...
**Foundations ready to build:** `F5` (delivery) · `F7` (search) · `F8` (Aurora patterns). _(`F3` jobs/outbox **done**; `F1` Person + `F4` documents + `F2` import **in-review** on `feat/phase1-foundations-f1-f2-f4` — full contract green locally.)_
