...
**Foundations ready to build:** `F5` (delivery) · `F7` (search) · `F8` (Aurora patterns). _(`F3` jobs/outbox **done**; `F1` Person + `F4` documents + `F2` import **in-review** ([PR #42](https://github.com/Ewosoft-Solutions/claude-trial/pull/42)) — full contract green locally.)_
...
| ID  | Title                                                                                                             | #           | Effort | Deps       | Owner  | Status           |
| --- | ----------------------------------------------------------------------------------------------------------------- | ----------- | ------ | ---------- | ------ | ---------------- |
| F1  | `Person`/identity/profile/membership separation + relationship history                                            | —           | XL     | ADR-01     | claude | in-review        |
| F2  | Shared **import & migration** platform (ImportJob/mapping/validate/commit/reconcile)                              | #26,#113    | XL     | F3, ADR-09 | claude | in-review        |
| F3  | Durable **job queue + transactional outbox + idempotency**                                                        | —           | L      | —          | claude | done             |
| F4  | **Document/attachment** service (scan/classify/retain/signed URLs)                                                | #28,#110    | L      | F3         | claude | in-review        |
