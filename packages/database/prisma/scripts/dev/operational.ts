...
const STARTER_APPLICATION_FORM = {
  ...
  description:
    'Tell us about your child. The standard sections below are the school’s core intake — a school can relabel, reorder, mark optional or hide them, and add its own questions.',
  settings: { progressBar: true },
  sections: [
    // ---- SYSTEM (bound) sections — the standard intake, editable-but-locked ----
    // Each `system` item is bound to a structured column and mapped onto the
    // createApplication payload; a school may relabel / reorder / mark optional /
    // hide, but not delete or retype. The extra (custom) sections follow.
    {
      id: 'sys-applicant',
      title: 'Applicant',
      system: true,
    ...
    // ---- Custom (school-authored) questions ----
    {
      id: 'sec-schooling',
