...
export const AUDIT_ACTION = {
  ...
  SECURITY: {
    ...
    POLICY: {
      ...
      UPDATE_SESSION_POLICY: 'update_session_policy',
      UPDATE_BIOMETRIC_ENROLLMENT_POLICY: 'update_biometric_enrollment_policy',
      UPDATE_SENSITIVE_OPERATION_POLICY: 'update_sensitive_operation_policy',
      REQUEST_SENSITIVE_OPERATION_CHANGE: 'request_sensitive_operation_change',
...
export const AUDIT_ACTION_VALUES = [
  ...
  AUDIT_ACTION.AUTHENTICATION.LOGOUT,
  AUDIT_ACTION.AUTHENTICATION.SESSION_REFRESHED,
  AUDIT_ACTION.AUTHENTICATION.SESSION_ROTATED,
  AUDIT_ACTION.AUTHENTICATION.TOKEN_REUSE_DETECTED,
  // Authorization
