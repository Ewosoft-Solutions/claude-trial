...
/* Route loading fallback for /finance/invoices AND everything beneath it.

   A segment's `loading.tsx` covers its child routes too — here, its `[id]` (detail) and `/new` (form) children are neither a table —
