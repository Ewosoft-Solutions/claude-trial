...
const STATS: StatItem[] = [
  ...
  },
  {
    ...
    value: '12',
    icon: <ClipboardList />,
    delta: { label: 'Due Friday', direction: 'up', intent: 'negative' },
...
const MY_CLASSES = [
  {
    key: 'c1',
    name: 'JSS 2A · Mathematics',
    time: '8:00 – 8:45 AM',
    done: true,
  },
  {
    key: 'c2',
    name: 'SS 1B · Further Maths',
    time: '9:00 – 9:45 AM',
    done: true,
  },
  {
    key: 'c3',
    name: 'JSS 3C · Mathematics',
    time: '11:00 – 11:45 AM',
    done: false,
  },
  {
    key: 'c4',
    name: 'SS 2A · Mathematics',
    time: '2:00 – 2:45 PM',
    done: false,
  },
];
              ...
              <>
                ...
                <Button size="sm" asChild>
                  <Link href="/attendance/daily">
                    <CalendarDays className="size-4" /> Take attendance
                  </Link>
                </Button>
              </>
            }
