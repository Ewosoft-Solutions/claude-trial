...
/* Route loading fallback for /classes/assessments/take AND everything beneath it.

   A segment's `loading.tsx` covers its child routes too — here, its `[id]` child is a detail page, not a table —
