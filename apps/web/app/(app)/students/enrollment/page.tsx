...
/* ============================================================
   /students/enrollment — the admissions pipeline

   A collection surface for incoming applications, built from the
   same recipe as the directory: M6 StatGrid (pipeline summary) +
   DataTableLayout (toolbar + table + footer) wired to the M5 states
   (SkeletonTable on a brief mount-time load, EmptyState with a
   reset when over-filtered). Stage + decision read as StatusBadges.
   Product copy + mock rows live here; the shared components stay
   data-driven. Replaces the `[...slug]` placeholder for this route.
   ============================================================ */
...
type Stage = 'application' | 'interview' | 'decision';
...
export default function EnrollmentPage() {
  ...
  }, [query, stageFilter, decisionFilter]);
