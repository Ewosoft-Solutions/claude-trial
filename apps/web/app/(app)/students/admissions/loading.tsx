...
/* Route loading fallback for /students/admissions AND everything beneath it.

   A segment's `loading.tsx` covers its child routes too — here, its `[id]` child is an application detail, not the pipeline table —
